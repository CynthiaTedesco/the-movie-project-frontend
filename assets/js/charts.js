import floatingTooltip from '@/assets/js/bubble-tooltip';
const d3 = require('d3');
...
export function bubbleChart() {
  ...
  // @v4 Force starts up automatically,CSV
 ...
 */
export function display(data, chart) {
  chart('#vis', data);
}
 ...
 */
export function setupButtons(chart) {
  d3.select('#toolbar')
    .selectAll('.button')
    .on('click', function() {
